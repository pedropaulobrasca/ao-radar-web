...
class PhotonCommand {
  ...
  parseReliableCommand() {
    ...
    switch (this.messageType) {
      case 2:
        this.data = deserializeOperationRequest(this.payload)

        this.parent.parent.emit('request', this.data)
        break
      case 3:
        this.data = deserializeOperationResponse(this.payload)

        this.parent.parent.emit('response', this.data)
        break
      case 4:
        this.data = deserializeEventData(this.payload)
