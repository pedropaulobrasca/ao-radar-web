...
export class MobsHandler {
  ...
  NewMobEvent(parameters) {
    ...
    const typeId = parseInt(parameters[1]) // real type id
    ...
    if (this.mobinfo[typeId] != null) {
      ...
      if (h.type === EnemyType.LivingSkinnable) {
        /* 
                ...
                */
        if (
          !this.settings.harvestingLivingHideTiers[h.tier - 1] ||
          !this.settings.harvestingLivingHideEnchants[enchant]
        ) {
        ...
        if (h.name === 'ore') {
          if (
            !this.settings.harvestingLivingOreTiers[h.tier - 1] ||
            !this.settings.harvestingLivingOreEnchants[enchant]
          ) {
            this.harvestablesNotGood.push(h)
            return
          }
          ...
          if (
            !this.settings.harvestingLivingRockTiers[h.tier - 1] ||
            !this.settings.harvestingLivingRockEnchants[enchant]
          ) {
            this.harvestablesNotGood.push(h)
            return
          }
          ...
          if (
            !this.settings.harvestingLivingLogTiers[h.tier - 1] ||
            !this.settings.harvestingLivingLogEnchants[enchant]
          ) {
            this.harvestablesNotGood.push(h)
            return
          }
          ...
          if (
            !this.settings.harvestingLivingFiberTiers[h.tier - 1] ||
  ...
  updateMobPosition(id, posX, posY) {
    const enemy = this.mobsList.find((enemy) => enemy.id === id)
  ...
  updateEnchantEvent(parameters) {
    ...
    if (enemy.type === EnemyType.LivingSkinnable) {
      if (
        !this.settings.harvestingLivingHideTiers[enemy.tier - 1] &&
        !this.settings.harvestingLivingHideEnchants[enemy.enchantmentLevel]
      )
        return
      ...
      if (enemy.name === 'ore') {
        if (
          !this.settings.harvestingLivingOreTiers[enemy.tier - 1] ||
          !this.settings.harvestingLivingOreEnchants[enemy.enchantmentLevel]
        )
          return
        ...
        if (
          !this.settings.harvestingLivingRockTiers[enemy.tier - 1] ||
          !this.settings.harvestingLivingRockEnchants[enemy.enchantmentLevel]
        )
          return
        ...
        if (
          !this.settings.harvestingLivingLogTiers[enemy.tier - 1] ||
          !this.settings.harvestingLivingLogEnchants[enemy.enchantmentLevel]
        )
          return
        ...
        if (
          !this.settings.harvestingLivingFiberTiers[enemy.tier - 1] ||
          !this.settings.harvestingLivingFiberEnchants[enemy.enchantmentLevel]
        )
          return
